...
hotlog_r = "" + Math.random() + "&amp;s=362992&amp;im=68&amp;r=" +
...
try {
    ...
    if(hdiv) {
        var ihtml = '<a href="http://click.hotlog.ru/?362992" target="_blank"><img ' +
            'src="https://hit17.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
        ...
        document.write('<a href="http://click.hotlog.ru/?362992" target="_blank"><img ' +
            'src="https://hit17.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
            '" class="hotlog_counter" border="0" alt="HotLog" title="HotLog" width="88" height="31"><\/a>');
    }
}
