...
}else{if(!Cackle.Login2.auth||(Cackle.Login2.auth&&Cackle.Login2.auth.id!=(A.author?A.author.id:A.anonym.id))){if(!A.parentId||!this.newreply(A)){this.rtcomments[0].push(A);
