...
;var F;a:{var la=t.navigator;if(la){var ma=la.userAgent;if(ma){F=ma;break a}}F=""};function na(a,b){var c=z(b),d=c?b:arguments;for(c=c?0:1;c<d.length&&(a=a[d[c]],void 0!==a);c++);return a}
