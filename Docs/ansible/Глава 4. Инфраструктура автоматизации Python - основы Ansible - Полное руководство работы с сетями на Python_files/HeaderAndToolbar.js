...
'	<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'logo\', \'click\', 1]);" target="_blank" href="https://www.packtpub.com/virtualization-and-cloud/">'+
'	<img src="/common/images/PacktPub-logo.jpg" alt="Документация Virtualization and Cloud" width="109" height="44"/></a>'+
''+
'	<h1>'+HeaderName+'</h1>'+
...
'		<a href="http://onreader.mdl.ru/MasteringAnsible2nd/content/index.html">Полное руководство Ansible, 2е изд.</a>'+
'		<a href="http://onreader.mdl.ru/UnixTheTextbook.3ed/content/Ch10.html">Главное пособие Unix. 3 ред.</a>'+
'		(<a onclick="_gaq.push([\'_trackEvent\', \'Header\', \'pdfDownload\', \'click\', 1]);" alt="Купите оригинал" class="pdficon" href="https://www.packtpub.com/networking-and-servers/mastering-python-networking">'+
