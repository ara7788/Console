...
smc_Toggle.prototype.changeState = function(bCollapse, bInit)
{
	...
	for (var i = 0, n = this.opt.aSwapBgposition.length; i < n; i++)
	{
		if (this.opt.aSwapBgposition[i] == null)
			continue;

		var oContainer = document.getElementById(this.opt.aSwapBgposition[i]);
		if (typeof(oContainer) == 'object' && oContainer != null)
			oContainer.style.backgroundPosition = bCollapse ? '0px -45px' : '';
	}
