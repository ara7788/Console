...
edButtons[edButtons.length] = new edButton('ed_strong', 'Жирный', '<strong>', '</strong>', 'b');edButtons[edButtons.length] = new edButton('ed_em', 'Курсив', '<em>', '</em>', 'i');edButtons[edButtons.length] = new edButton('ed_del', 'del', '<del>', '</del>', 'd');edButtons[edButtons.length] = new edButton('ed_link', 'Ссылка', '<a>', '</a>', 'a');edButtons[edButtons.length] = new edButton('ed_block', 'Цитата', '<blockquote>', '</blockquote>', 'q');edButtons[edButtons.length] = new edButton('ed_code', 'Код', '<code>', '</code>', 'c');edButtons[edButtons.length] = new edButton('ed_close', 'Закрыть теги', '', '', '');
