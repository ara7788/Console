...
global_on_behalf_title='Sending settings';
...
global_test_key_js_2='Test key eng';
global_to_top='Go up';
...
Save='Save';
Secondary_education='Secondary and further education';
Sex='Sex:';
Sex_fm='Female';
Sex_m='Male';
...
audio_row_action__add_pl='Add to playlist';
audio_row_action__share='Share';
...
groups_app_edit_box_title='Application Settings';
...
abuse_goto_support='If you want to delete a profile created in your name or your old account, please <a class="wikiVkLink" href="http://vk.com/support?act=new&amp;from=abuse">contact our Support</a>. ';
// section = 58; version = 20;
...
mobile_audio_count=['','%s audio file','%s audio files'];
mobile_edit_country_null='None selected';
mobile_fave_market='Add to bookmarks';
mobile_fave_post='Ïðî÷èòàòü ïîçæå';
mobile_fave_video='Watch later';
...
mobile_mail_hours_ago=['','%s hour ago','%s hours ago'];
mobile_mail_im_joined_chat_from_invitation=['','{from} joined the conversation','{from} joined the conversation'];
mobile_mail_just_now='Just now';
mobile_mail_last_activity_tip=['','was online {time}','was online {time}'];
mobile_mail_messages_selected=['','Selected {count} message','Selected {count} messages'];
mobile_mail_mins_ago=['','%s minute ago','%s minutes ago'];
...
mobile_msg_cant_send_msg='You cannot message this user due to their privacy settings.';
mobile_msg_cant_send_msg2='Unfortunately, the message cannot be sent due to the privacy settings.';
mobile_msg_cant_send_notfriend='Only friends can send messages to this user.';
mobile_msg_mail_message_sent='Message sent.';
mobile_msg_mail_not_friend_in_chat='You can only add friends to conversations.';
mobile_msg_mail_privacy_error='Unfortunately, the message cannot be sent due to the privacy settings.';
mobile_msg_mail_server_error='Server error: cannot send message.';
mobile_msg_mail_spam_chain_detected='You have just tried to send a so called &#39;chain letter&#39;. These are mostly meaningless messages containing threats, doomsday predictions etc. This is not welcome on VK.com';
mobile_msg_mail_too_many_recipients='Unfortunately, the message cannot be sent, since you have sent too many messages recently.';
...
mobile_playlist_added='Äîáàâëåí';
mobile_playlist_play='Play';
...
mobile_unfave_market='Bookmarked';
mobile_unfave_post='Remove from bookmarks';
mobile_unfave_video='Remove from bookmarks';
mobile_unknown_error='Unknown error';
mobile_wall_publish_postponed='Publish now';
mobile_zphoto_save_btn='Save';
// section = 61; version = 99;
