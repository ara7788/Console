...
hotlog_r = "" + Math.random() + "&amp;s=2223755&amp;im=560&amp;r=" +
...
try {
    ...
    if(hdiv) {
        var ihtml = '<a href="http://click.hotlog.ru/?2223755" target="_blank"><img ' +
            'src="http://hit40.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
        ...
        document.write('<a href="http://click.hotlog.ru/?2223755" target="_blank"><img ' +
            'src="http://hit40.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
            '" class="hotlog_counter" border="0" alt="HotLog" title="HotLog" width="88" height="31"><\/a>');
    }
}
