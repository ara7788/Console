...
hotlog_r = "" + Math.random() + "&amp;s=2210476&amp;im=73&amp;r=" +
...
try {
    ...
    if(hdiv) {
        var ihtml = '<a href="http://click.hotlog.ru/?2210476" target="_blank"><img ' +
            'src="https://hit40.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
        ...
        document.write('<a href="http://click.hotlog.ru/?2210476" target="_blank"><img ' +
            'src="https://hit40.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
            '" class="hotlog_counter" border="0" alt="HotLog" title="HotLog" width="88" height="31"><\/a>');
    }
}
